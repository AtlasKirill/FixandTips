import CommandantNews from './CommandantNews.jsx';
...
class CommandantNewsList extends React.Component{
    ...
    render(){
        ...
        const news = this.props.newsList.map(
            ...
            item =>  <CommandantNews key = { item } id = { item }/>,
        );
        return( 
            <div>
               { news } 
...
export default connect(mapStateToProps, mapDispatchToProps)(CommandantNewsList);